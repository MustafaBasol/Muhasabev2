    ...
    try {
      ...
      if (row.type === 'invoice') {
        ...
        const mapped: InvoiceViewModel = {
          ...
          createdByName: (inv as any)?.createdByName,
          createdByUser: (inv as any)?.createdByUser,
          createdBy: (inv as any)?.createdBy,
          updatedByName: (inv as any)?.updatedByName,
          updatedByUser: (inv as any)?.updatedByUser,
          updatedBy: (inv as any)?.updatedBy,
          items: items.map((li) => ({
        ...
        const mapped: QuoteModel = {
          ...
          createdByName: (q as any)?.createdByName,
          updatedByName: (q as any)?.updatedByName,
        ...
        const mapped: SaleViewModel = {
          ...
          createdByName: (s as any)?.createdByName,
          updatedByName: (s as any)?.updatedByName,
